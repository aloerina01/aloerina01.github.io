...
fetch_revisions () {
  api_path="https://api.github.com/repos/aloerina01/aloerina01.github.io/commits/gh-actions/20191224/check-runs?status=completed&token=$github_token&check_name=Indexing+into+Algolia"
